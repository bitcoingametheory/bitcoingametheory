...
The view of this paper, in line with Szabo\textsuperscript{23}, is the opposite of Budish: mining energy is the unforgeable costliness sustaining neutral settlement.\textsuperscript{24} Three results triangulate the intertwined cryptographic and economic hardness Assumption~3 refers to. Biais, Bisi\`ere, Bouvard, and Casamatta\textsuperscript{4} show that following the longest chain is a stable equilibrium in the mining subgame. Garay, Kiayias, and Leonardos\textsuperscript{13} prove that under honest majority the protocol delivers common prefix, chain quality, and chain growth: the formal cryptographic guarantee that proof-of-work yields consensus. Chen\textsuperscript{8} closes the price-security loop in general equilibrium.
