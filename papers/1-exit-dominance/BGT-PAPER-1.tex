...
the Exit Game, a non-cooperative game in which allocators choose
...
reached (Proposition~2). Third, the high-Exit region above a critical
mass is coalition-proof against returning Stay coalitions, and persistent
debasement drives that critical mass monotonically downward over time (Theorem~1). Together these
