...
\hypersetup{
  ...
  pdftitle={Settlement at Zero Trust: Bitcoin and Autonomous Economic Agents},
  pdfauthor={Sean Hash},
  pdfkeywords={Bitcoin, AI agents, autonomous settlement, trust gradient, zero recourse, game theory, legal personhood, cryptographic settlement, Nash equilibrium, network effects}
}
...
{\small
\textbf{JEL Codes:} C72, D82, D83, E42, G11, L14, O33\\[4pt]
\textbf{Keywords:} Bitcoin, AI agents, autonomous settlement, trust gradient, zero recourse, game theory, Nash equilibrium, cryptographic settlement, network effects
}
\end{center}
...
human actor. AI agents reach their adoption threshold $p_j^*$
...
This pushes human actors closer to their thresholds $p_i^*$,
