...
\hypersetup{
  ...
  pdftitle={Monetary Predator-Prey Dynamics: Enforcement Gridlock and Neutral Settlement Survival},
  pdfauthor={Sean Hash},
  pdfkeywords={Bitcoin, Lotka-Volterra, enforcement gridlock, predator-prey dynamics, neutral settlement, coordination failure, coalition stability, game theory}
}
...
{\small
\textbf{JEL Codes:} C72, C73, D74, E42, F33, G15, L14\\[4pt]
\textbf{Keywords:} Bitcoin, Lotka--Volterra, enforcement gridlock, predator-prey dynamics, neutral settlement, coordination failure, coalition stability, game theory, network effects
}
\end{center}
